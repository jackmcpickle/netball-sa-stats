...
export function llmsTxt(input: LlmsTxtInput): string {
    ...
    return [
        ...
        '## Pages',
        '',
        `- [Club championship rankings](${absoluteUrl('/index.md')}): the combined AMND / Premier League / Reserves score.`,
        `- [Leagues](${absoluteUrl('/leagues.md')}): each association’s own clubs, ladders and (where weighted) championship.`,
        ...
        '## Query parameters',
        '',
        '- `/ladders.md?year=YYYY&grade=GRADE_KEY&competition=COMPETITION_KEY`',
        '- `/leagues.md` and `/leagues/COMPETITION_KEY.md`',
