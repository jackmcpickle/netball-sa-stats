/**
 * Upserts `ImportData` into D1. Live fetch builds rows in memory; this
 * module also still loads leftover / fixture CSVs from disk. Talks to D1
 * only through the injected `ImportExecutor`. Thin CSV CLI lives in
